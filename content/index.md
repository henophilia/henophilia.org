...
Henophilia can be seen as a path towards the highest stage of Maslow's hierarchy of needs, "transcendence". Answering "to be or not to be?" with an enthusiastic "let's be!". It aims to make the [numinous](https://en.wikipedia.org/wiki/Numinous) ultimately joyful. It is [Divine Eros](https://en.wikipedia.org/wiki/Platonic_love#Eros). It is the [principles of good sex applied to the rest of one's life](https://chatgpt.com/share/670bc9db-555c-8003-a2c0-7773e8bbe204).
...
Henophilia strives to stimulate the creation of [morally universalist](https://en.wikipedia.org/wiki/Moral_universalism) tenets. After for a long time, some belief and value systems have developed to be morally incompatible with each other, henophilia motivates the **radical, limitless willingness and openness** to overcome these sometimes deeply engrained dichotomies and instead transition to a dialogue akin to "I find something to be morally right. You find the same thing to be morally wrong. So how can we understand each other and subsequently expand our view of morality to unify our counterpositions?". This means it is also closely connected to [relational-cultural theory](https://en.wikipedia.org/wiki/Relational-cultural_therapy) as well as [nonviolent communication](https://en.wikipedia.org/wiki/Nonviolent_Communication).
